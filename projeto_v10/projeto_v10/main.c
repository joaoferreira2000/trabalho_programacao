    ...
    printf("\nIntroduza o numero de identificacao do computador:\n");
        do
        {
            ...
            for (i=0; i<100;i++)
            {
                ...
                else if (f_n_id_computador[i]=='\0' && repeat==0)
                {
                    for (x=0; x<25;x++)
                    {
